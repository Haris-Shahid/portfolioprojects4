...
firebase.initializeApp(config);
  ...
  var dbRef = db.ref('signalservices');
  
var arrdetail = []
  dbRef.on('child_added', snap => {
    //    console.log(snap.val())
       arrdetail.push(snap.val())
    //    console.log(arrdetail)
       for(var i = 0 ; i < arrdetail.lenght ; i++){
           var a = new Array()
            a.push(arrdetail[array.lenght])
             console.log(a)
            //  return a[arrdetail.lenght]   
       }
    //    console.log(a)
    //   for(var i = 0 ; i < )
    // console.log(arr)
    ...
    //       console.log(signalservicefirebase[i])
    //         for(var j = 0 ; j < signalservicefirebase.length; j++ ){
    //             // console.log(signalservicefirebase[j])
                
    //         }
            
    //   }
    //   signalservicefirebase.forEach((service) => {
    //       console.log(service)
    ...
    // })
    // signalservicefirebase.map((service,index)=>{
    //     console.log(service)
    //           cell0.innerHTML = service.pair ;
    //           cell1.innerHTML = service.action ;
    //           cell2.innerHTML = service.entry ;
 ...
 function addhtmltable(){
  ...
  if(!checkEmptyInput()){
     ...
     var newRow = table.insertRow(table.length),
         ...
         cell0.innerHTML = pair ;
         cell1.innerHTML = action ;
         cell2.innerHTML = entry ;
         cell3.innerHTML = TP ;
         cell4.innerHTML = SI ;
